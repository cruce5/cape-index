...
const dc = sum(films.filter((f) => f.universe !== "MCU"));
...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}" viewBox="0 0 ${W} ${H}">
  ...
  <text x="80" y="524" font-family="${SANS}" font-size="30" font-weight="700" fill="#f2f3f7">${usd(mcu + dc)} worldwide &#183; ${films.length} films</text>
